...
public abstract class DatabaseConnection {
	...
	/**
	 * The amount of times reconnecting has been attempted.
	 */
	...
	public Statement createStatement() throws SQLException {
		...
		try {
			if (connection == null) {
				connect();
				if (attempts++ == 10) {
					World.safeShutdown(true, 0);
				}
				throw new SQLException("Database not connected yet! Attempting to reconnect (Try #" + attempts + ")...");
			}
