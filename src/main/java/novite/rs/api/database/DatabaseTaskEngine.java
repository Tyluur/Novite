...
import novite.rs.api.database.task.QueryTask;
import novite.rs.api.database.task.TaskComparator;

public class DatabaseTaskEngine {

	private boolean running = false;

	private BlockingQueue<QueryTask> tasks = new PriorityBlockingQueue<QueryTask>(10, new TaskComparator());
