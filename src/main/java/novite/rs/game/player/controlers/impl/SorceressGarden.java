...
import novite.rs.game.player.actions.HerbCleaning.Herbs;
import novite.rs.game.player.content.FadingScreen;
import novite.rs.game.player.content.Magic;
import novite.rs.game.player.controlers.Controller;
import novite.rs.game.player.dialogues.impl.SqirkFruitSqueeze.SqirkFruit;
...
public class SorceressGarden extends Controller {
	...
	public enum Gate {
		...
		21709,
		1,
		new WorldTile(2902, 5470, 0),
		new WorldTile(2903, 5470, 0),
		231),
		SPRING(
		21753,
		25,
		new WorldTile(2921, 5473, 0),
		new WorldTile(2920, 5473, 0),
		228),
		AUTUMN(
		21731,
		45,
		new WorldTile(2913, 5462, 0),
		new WorldTile(2913, 5463, 0),
		229),
		SUMMER(
		21687,
		65,
		new WorldTile(2910, 5481, 0),
		new WorldTile(2910, 5480, 0),
		230);
