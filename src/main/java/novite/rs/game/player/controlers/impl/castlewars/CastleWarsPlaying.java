package novite.rs.game.player.controlers.impl.castlewars;
...
public class CastleWarsPlaying extends Controller {
	...
	public boolean canDropItem(Item item) {
		if (item.getDefinitions().getName().toLowerCase().contains("flag")) {
			player.getPackets().sendGameMessage("You cannot drop the flag!");
			return false;
		}
		return true;
	}
	...
	public void passBarrier(WorldObject object) {
		if (hasFlag()) {
			player.getPackets().sendGameMessage("You can't cross barrier with flag.");
			return;
		}
