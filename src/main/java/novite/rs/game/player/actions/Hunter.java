...
public class Hunter {
	...
	public enum FlyingEntities {
		...
		25,
		17,
		new Item[] { new Item(946, 1), new Item(1755, 1), new Item(1734, 1), new Item(1733, 1), new Item(2347, 1), new Item(1985, 1) },
		new Item[] { new Item(1927, 1), new Item(319, 1), new Item(2007, 1), new Item(1779, 1), new Item(7170, 1), new Item(401, 1), new Item(1438, 1) },
		new Item[] { new Item(2355), new Item(1607), new Item(1743), new Item(379), new Item(1761) },
		null),
		...
		65,
		22,
		new Item[] { new Item(361, 1), new Item(1901, 1), new Item(1539, 5), new Item(1784, 4), new Item(1523, 1), new Item(7936, 1), new Item(5970, 1) },
		new Item[] { new Item(855, 1), new Item(1353, 1), new Item(2293, 1), new Item(7178, 1), new Item(247, 1), new Item(453, 1), new Item(1777, 1), new Item(231, 1), new Item(2347, 1) },
		new Item[] { new Item(1097, 1), new Item(1157, 1), new Item(8778, 1), new Item(133, 1), new Item(2359, 1), },
		null),
		...
		113,
		28,
		new Item[] { new Item(361, 1), new Item(365, 1), new Item(1897, 1), new Item(2007, 1), new Item(2011, 1), new Item(2293, 1), new Item(2327, 1), new Item(5970, 1) },
		new Item[] { new Item(247, 1), new Item(379, 1), new Item(385, 1), new Item(1883, 1), new Item(1885, 1), new Item(5755, 1), new Item(6969, 1), new Item(7170, 1), new Item(7178, 1), new Item(7188, 1), new Item(7754, 1), new Item(8244, 1), new Item(8526, 1) },
		new Item[] { new Item(373, 1), new Item(5406, 1), new Item(5755, 1), new Item(7170, 1), new Item(7178, 1), new Item(7178, 1), new Item(7188, 1), new Item(7754, 1), new Item(8244, 1), new Item(8526, 1), new Item(10136, 1), new Item(14831, 1), new Item(10137, 5) },
		null),
		...
		177,
		36,
		new Item[] { new Item(444, 1), new Item(557, 32), new Item(1441, 6), new Item(1442, 1), new Item(2353, 1), new Item(5104, 1), new Item(5535, 1), new Item(6032, 1), new Item(20904, 1), new Item(20914, 1), new Item(20942, 1), new Item(24216, 1), new Item(24767, 1) },
		new Item[] { new Item(237, 1), new Item(447, 1), new Item(1273, 1), new Item(454, 6), new Item(1487, 1), new Item(5311, 2), new Item(5294, 2) },
		new Item[] { new Item(448, 1), new Item(1606, 2), new Item(6035, 2), },
		new Item[] { new Item(1603, 1), new Item(5303, 1) }),
															...
															*/, new Item(555, 30) /*
																					...
																					*/, new Item(556, 60) /*
																											...
																											*/, new Item(559, 30) /*
																																	* Body
																																	* rune
																																	*/, new Item(1448, 1), new Item(7937, 20) },
		...
		new Item[] { new Item(560, 13) /*
										...
										*/, new Item(561, 13) /*
																...
																*/, new Item(563, 13) /*
																						* Law
																						* rune
																						*/, new Item(566, 13), new Item(1442, 1) },
		null),
		...
		321,
		54,
		new Item[] { new Item(12155, 25), new Item(12109, 1) /*
																* Cockatrice
																* egg
																*/, new Item(12113, 1) /*
																						* Saratrice
										...
										*/, new Item(5299, 1), new Item(5297, 1) /*
																					...
																					*/, new Item(3051, 1), new Item(5285, 1) /*
																																...
																																*/, new Item(5286, 1), new Item(5313, 1) /*
																																											* Willow
																																											* seed
																																											*/, new Item(5974, 1) /* Coconut */, },
		new Item[] { new Item(5304, 1) /*
										* Torstol
										* seed
										*/, new Item(5295, 1) },
		new Item[] { new Item(5303, 1) /*
										* Dwarf
										* weed
										* seed
										*/, new Item(219, 1) /*
																						...
																						*/, new Item(4097, 1) /*
																												...
																												*/, new Item(4095, 1) /*
																																		...
																																		*/, new Item(2364, 2) /*
																																								* Rune
																																								* bar
																																								*/, new Item(1603, 1) /* Ruby */, },
		new Item[] { new Item(1215, 1) /*
										* Dragon
										* dagger
										*/, new Item(1185, 1) /*
																* Rune
																																						...
																																						*/, new Item(1333, 1), new Item(1347, 1) /*
																																																	...
																																																	*/, new Item(1215, 1), new Item(6313, 1) /*
																																																												...
																																																												*/, new Item(892, 70), new Item(811, 70) /*
																																																																							* Rune
																																																																							* dart
																																																																							*/, new Item(868, 40), new Item(1747, 16), new Item(140, 4), new Item(805, 40), new Item(25496, 4), },
		new Item[] { new Item(9342, 1), new Item(6155, 1) /*
															* Dagannoth
															* hide
															*/},
		...
		617,
		91,
		new Item[] { new Item(1705, Utils.random(3, 11)), new Item(1684, 3), new Item(1618, Utils.random(17, 34)), new Item(990, 2) },
		new Item[] { new Item(1631, 1), new Item(1615, 1), new Item(9341, 40 + Utils.getRandom(30)), new Item(9342, 57), new Item(15511, 1), new Item(15509, 1), new Item(15505, 1), new Item(15507, 1), new Item(15503, 1), new Item(11212, 40 + Utils.random(104)), new Item(9193, 62 + Utils.random(8)), new Item(11230, Utils.random(182, 319)), new Item(11232, 70), new Item(1306, Utils.random(1, 2)), new Item(1249, 1) },
		null,
		new Item[] { new Item(7158, 1), new Item(2366, 1), new Item(6571, 1) }),
	...
	public static boolean isSuccessful(Player player, int dataLevel, DynamicFormula formula) {
		...
		return Utils.percentageChance(80);
	}
}