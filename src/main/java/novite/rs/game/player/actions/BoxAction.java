...
public class BoxAction extends Action {
	...
	public enum HunterNPC {
		...
		SPINED_LARUPIA(5104, new Item[] { new Item(532, 1), new Item(10093, 1) }, 31, 180, HunterEquipment.LARUPIA_PITFALL, 19232, -1, new Animation(-1), new Animation(5231));// might
	...
	public int processWithDelay(Player player) {
		...
		OwnedObjectManager.addOwnedObjectManager(player, new WorldObject[] { new WorldObject(hunt.getObjectId(), 10, 0, player.getX(), player.getY(), player.getPlane()) }, new long[] { 600000 });
		return -1;
	}
