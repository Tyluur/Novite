...
import novite.rs.game.player.content.achievements.impl.ArdougneMediumAchievement;
...
public class Thieving {
	...
	public enum Stalls {
		...
		0,
		2,
		new int[] { 1957, 1965, 1942, 1982, 1550 },
		1,
		2,
		10,
		34381),
		...
		14011,
		22,
		new int[] { 1937, 1993, 1987, 1935, 7919 },
		1,
		16,
		27,
		2046),
		...
		7053,
		27,
		new int[] { 5096, 5097, 5098, 5099, 5100, 5101, 5102, 5103, 5105 },
		30,
		11,
		10,
		2047),
			...
			if (stall.getObjectId() == object.getId()) {
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						if (!gaveItems) {
							if (player.getRegionId() == 10547) {
								player.getAchievementManager().notifyUpdate(ArdougneMediumAchievement.class);
							}
