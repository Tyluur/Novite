...
import novite.rs.game.player.content.achievements.impl.BlackIbisAchievement;
import novite.rs.game.player.content.achievements.impl.PickpocketingMediumAchievement;
...
public class PickPocketAction extends Action {
	...
	private boolean isSuccesfull(Player player) {
		...
		double ratio = level / (Utils.random(npcData.getThievingLevels()[0] + 6) + 1); // dammit
		// u
		// fail
