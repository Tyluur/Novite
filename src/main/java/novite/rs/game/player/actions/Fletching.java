...
public class Fletching extends Action {
	...
	public int processWithDelay(Player player) {
		...
		if (player.getControllerManager().getController() instanceof GamesHandler) {
			double points = 0;
			switch(fletch) {
			case STRUNG_WILLOW_SHORT_BOW:
				points = 0.5;
				break;
			case STRUNG_WILLOW_LONG_BOW:
				points = 0.75;
				break;
			case STRUNG_MAPLE_SHORT_BOW:
				points = 1;
				break;
			case STRUNG_MAPLE_LONG_BOW:
				points = 1.5;
				break;
			case STRUNG_YEW_LONG_BOW:
				points = 2.5;
				break;
			case STRUNG_YEW_SHORT_BOW:
				points = 2;
				break;
			case STRUNG_MAGIC_LONG_BOW:
				points = 4.5;
				break;
			case STRUNG_MAGIC_SHORT_BOW:
				points = 4;
				break;
			default:
				points = 1;
