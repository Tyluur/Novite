...
public class ExchangeOffer {
	...
	/**
	 * The amount of the offer that the owner has selected out of the processed
	 * amount
	 */
	...
	/**
	 * If the offer has finished, based on whether the {@link #amountProcessed}
	 * is at the {@link #amountRequested} value
	 */
	...
	public ItemsContainer<Item> getItemsToCollect() {
		ItemsContainer<Item> items = new ItemsContainer<Item>(2, true);
