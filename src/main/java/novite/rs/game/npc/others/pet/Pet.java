package novite.rs.game.npc.others.pet;
...
import novite.rs.game.player.content.pet.PetDetails;
...
public final class Pet extends NPC {
	...
	public void pickup() {
		...
		owner.getPetManager().setItemId(-1);
		switchOrb(false);
		owner.getPackets().closeInterface(owner.getInterfaceManager().hasResizableScreen() ? 169 : 194);
		owner.getPackets().sendIComponentSettings(747, 17, 0, 0, 0);
		finish();
	}
