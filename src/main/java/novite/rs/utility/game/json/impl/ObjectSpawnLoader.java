 ...
 * @since Mar 21, 2014
 */
public class ObjectSpawnLoader extends JsonLoader<ObjectSpawnLoader.ObjectSpawn> {
	...
	public static final void loadObjectSpawns(int regionId) {
		...
		for (ObjectSpawn spawn : spawns) {
			World.spawnObject(new WorldObject(spawn.getId(), spawn.getType(), spawn.getRotation(), spawn.getX(), spawn.getY(), spawn.getPlane()));
		}
	}
