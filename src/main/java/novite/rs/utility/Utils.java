...
public final class Utils {
	...
	public enum CombatRates {
		...
		CombatRates(double combat, double skill, double loot) {
			this.combat = combat;
			this.skill = skill;
			this.loot = loot;
		}
	...
	public static boolean animationExists(int emoteId) {
		return Cache.STORE.getIndexes()[20].fileExists(emoteId >>> 7, emoteId & 0x7f);
	}

	public static boolean npcExists(int npcId) {
		return Cache.STORE.getIndexes()[18].fileExists(npcId >>> 134238215, npcId & 0x7f);
	}
